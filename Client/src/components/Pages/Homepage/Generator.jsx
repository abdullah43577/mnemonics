  ...
  return (
    <section className="flex items-start gap-32 my-16">
      <div>
        ...
        <div className="border border-gray-200 rounded-lg relative py-6 px-2 w-full my-4 overflow-hidden cursor-pointer" onClick={() => setIsModalOpen(!isModalOpen)}>
          <span className="hd">Upgrade to plus for more features</span>

          <svg className="absolute right-0 -bottom-4" width="75" height="72" viewBox="0 0 75 72" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <button className="generator rounded-lg text-white py-4 px-6 w-full mb-8" onClick={generateMnemo}>
          Start Generator
        </button>
      </div>
