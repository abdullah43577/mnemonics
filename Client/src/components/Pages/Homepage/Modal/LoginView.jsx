...
export default function LoginView() {
  ...
  return (
    <div className={`loginView px-8 xl:px-10 ${modalState.loginView ? 'block' : 'hidden'}`}>
      <h2 className="font-[900] text-3xl xl:text-4xl">Welcome,</h2>
      ...
      <div>
        <div className="border border-gray-200 rounded-lg w-full flex items-center justify-center gap-2 py-2 px-6 cursor-pointer mb-6">
          ...
          <p className="text-[#838393] text-sm xl:text-lg">Continue with Google</p>
        </div>
        ...
        <div className="border border-gray-200 rounded-lg w-full flex items-center justify-center gap-2 py-2 px-6 cursor-pointer mb-6">
          ...
          <p className="text-[#838393] text-sm xl:text-lg">Continue with Apple</p>
        </div>
      </div>
