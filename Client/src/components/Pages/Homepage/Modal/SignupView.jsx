...
export default function SignupView() {
  ...
  return (
    <div className={`signupView px-8 xl:px-10 ${modalState.signupView ? 'block' : 'hidden'}`}>
      <h2 className="font-[900] text-[40px] leading-[36px] tracking-[-2.64px]">Hello there,</h2>
      <p className="text-[#838393] my-4">Welcome back champ! Sign in to your QuickMnemo account and continue your memorization journey</p>
