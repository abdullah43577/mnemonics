...
export default function SignupView() {
  ...
  return (
    <div className={`signupView px-8 xl:px-10 ${modalState.signupView ? 'block' : 'hidden'}`}>
      <h2 className="font-[900] text-3xl xl:text-4xl">Hello there,</h2>
      <p className="text-[#838393] text-sm xl:text-lg my-4">Welcome back champ! Sign in to your QuickMnemo account and continue your memorization journey</p>

      <div>
        <div className="border border-gray-200 rounded-lg w-full flex items-center justify-center gap-2 py-2 px-6 cursor-pointer mb-6">
          ...
          <p className="text-[#838393] text-sm xl:text-lg">Sign up with Google</p>
        </div>

        <div className="border border-gray-200 rounded-lg w-full flex items-center justify-center gap-2 py-2 px-6 cursor-pointer">
          ...
          <p className="text-[#838393] text-sm xl:text-lg">Sign up with Apple</p>
        </div>
      </div>
